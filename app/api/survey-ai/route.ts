...
const schema = z.object({ surveyId: z.string().min(1), mode: z.enum(["suggest", "review", "question-review", "question-followup"]), brief: z.string().optional(), instruction: z.string().optional(), questionId: z.string().optional() }).strict();
