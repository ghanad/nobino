...
export const ACTION_LABELS: Record<string, string> = {
  ...
  DOCUMENT_CREATED: "سند ایجاد شد",
  DOCUMENT_DELETED: "سند حذف شد",
  DOCUMENT_IMAGE_DELETED: "تصویر سند حذف شد",
  DOCUMENT_IMAGE_UPLOADED: "تصویر سند بارگذاری شد",
  DOCUMENT_MOVED: "سند منتقل شد",
  DOCUMENT_RENAMED: "نام سند تغییر کرد",
  DOCUMENT_REORDERED: "ترتیب سند تغییر کرد",
  DOCUMENT_UPDATED: "محتوای سند ویرایش شد",
...
export const ENTITY_LABELS: Record<string, string> = {
  ...
  DocumentImage: "تصویر مستندات",
  DocumentNode: "مستندات",
...
const FIELD_LABELS: Record<string, string> = {
  ...
  contentBytes: "حجم محتوا",
  contentHash: "اثر انگشت محتوا",
  date: "تاریخ",
  email: "ایمیل",
  endAt: "پایان",
  endTime: "پایان کار",
